...
keywords: Azure, java, SDK, API, azure-resourcemanager-machinelearningservices,
ms.date: 04/16/2021
ms.topic: reference
ms.devlang: java
ms.service: 
---
# Azure Resource Manager MachineLearningServices client library for Java - version 1.0.0-beta.1 
...
For details on contributing to this repository, see the [contributing guide](https://github.com/Azure/azure-sdk-for-java/blob/azure-resourcemanager-machinelearningservices_1.0.0-beta.1/CONTRIBUTING.md).
...
[design]: https://github.com/Azure/azure-sdk-for-java/blob/azure-resourcemanager-machinelearningservices_1.0.0-beta.1/sdk/resourcemanager/docs/DESIGN.md
