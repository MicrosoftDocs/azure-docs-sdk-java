---
title: Azure identity JDBC plugin library for Java
keywords: Azure, java, SDK, API, azure-identity-providers-core, jdbc
ms.date: 09/23/2022
ms.topic: reference
ms.devlang: java
ms.service: jdbc
...
For details on contributing to this repository, see the [contributing guide](https://github.com/Azure/azure-sdk-for-java/blob/azure-identity-providers-core_1.0.0-beta.1/CONTRIBUTING.md).
