---
title: Azure DeviceRegistry software update client library for Java
keywords: Azure, java, SDK, API, azure-iot-deviceregistry-softwareupdate, deviceregistry
ms.date: 09/18/2026
ms.topic: reference
ms.devlang: java
ms.service: deviceregistry
---
# Azure DeviceRegistry software update client library for Java - version 1.0.0-alpha.20260918.1 
